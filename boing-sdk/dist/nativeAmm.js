...
export function encodeNativeAmmSetFeeAdminCalldata(adminHex32) {
    const out = new Uint8Array(64);
...
export function encodeNativeAmmSetFeeAdminCalldataHex(adminHex32) {
...
export function constantProductAmountOutFeeOnInput(reserveIn, reserveOut, amountIn) {
    return constantProductAmountOutFeeOnInputWithFeeBps(reserveIn, reserveOut, amountIn, BigInt(NATIVE_CP_SWAP_FEE_BPS));
}
/**
