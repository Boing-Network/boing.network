 ...
 */
export function encodeNativeDexLedgerRouterForwardCalldata(
  poolHex32: string,
  innerPoolCalldata128: Uint8Array
): Uint8Array {
...
export function encodeNativeDexLedgerRouterForwardCalldataHex(
  poolHex32: string,
  innerPoolCalldata128: Uint8Array
): string {
 ...
 */
export function encodeNativeDexLedgerRouterForwardCalldataV2(
  poolHex32: string,
  innerPoolCalldata160: Uint8Array
): Uint8Array {
...
export function encodeNativeDexLedgerRouterForwardCalldataV2Hex(
  poolHex32: string,
  innerPoolCalldata160: Uint8Array
): string {
 ...
 */
export function encodeNativeDexLedgerRouterForwardCalldataV3(
  poolHex32: string,
  innerPoolCalldata192: Uint8Array
): Uint8Array {
...
export function encodeNativeDexLedgerRouterForwardCalldataV3Hex(
  poolHex32: string,
  innerPoolCalldata192: Uint8Array
): string {
 ...
 */
export function buildNativeDexLedgerRouterAccessList(
  senderHex32: string,
  routerHex32: string,
  poolHex32: string
...
export function buildNativeDexLedgerRouterContractCallTx(
  senderHex32: string,
  routerHex32: string,
  poolHex32: string,
  innerPoolCalldata128: Uint8Array
...
export function mergeNativeDexLedgerRouterAccessListWithSimulation(
  senderHex32: string,
  routerHex32: string,
  poolHex32: string,
  sim: SimulateResult
...
export function buildNativeDexLedgerRouterV2ContractCallTx(
  senderHex32: string,
  routerHex32: string,
  poolHex32: string,
  innerPoolCalldata160: Uint8Array
...
export function buildNativeDexLedgerRouterV3ContractCallTx(
  senderHex32: string,
  routerHex32: string,
  poolHex32: string,
  innerPoolCalldata192: Uint8Array
