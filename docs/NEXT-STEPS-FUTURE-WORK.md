...
| **Fee market v0** | **Done:** `ceil(gas_used × GAS_PRICE / GAS_UNITS_PER_BOING)` (1 BOING per 21k gas); split via `FEE_*_BPS` to proposer / `PROTOCOL_TREASURY` / burn sink in `BlockExecutor`. No EIP-1559 / tip auctions yet. |
