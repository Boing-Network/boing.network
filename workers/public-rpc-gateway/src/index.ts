 ...
 * fail over between backends, and keep the stable public hostname independent
 * of a home Cloudflare Tunnel connector.
 */
...
async function proxyOnce(origin: string, req: Request, body: ArrayBuffer | null): Promise<Response> {
